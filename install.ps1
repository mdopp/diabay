...
pip install fastapi uvicorn sqlalchemy aiosqlite pydantic pydantic-settings python-multipart aiofiles httpx tqdm watchdog websockets transformers --upgrade --quiet
